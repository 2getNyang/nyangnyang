...
const TestPage7 = () => {
  ...
  const currentUserId = 7; // 고정된 사용자 ID

  // 테스트용 게시글 데이터
  const testPost = {
    id: 1,
    categoryId: 2,
    userId: 6, // 작성자 ID (7과 다른 ID로 설정)
    nickname: '다른작성자',
    lostType: '실종',
    kindName: '푸들',
    age: 2,
    ...
    missingLocation: '반포동 한강공원 근처',
    phone: '010-9876-5432',
    likeCount: 18,
    comments: [],
    imageUrls: ['https://images.unsplash.com/photo-1616190264687-b7ebf7aa7433?w=500'],
