...
const TestPage = () => {
  ...
  const [currentUserId, setCurrentUserId] = useState(6); // 기본값을 6으로 설정
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="flex items-center space-x-4">
              <span className="text-sm font-medium">현재 로그인한 사용자 ID:</span>
              <div className="flex space-x-2">
                <Button
                  variant={currentUserId === 6 ? "default" : "outline"}
                  size="sm"
                  onClick={() => setCurrentUserId(6)}
                >
                  ID: 6
                </Button>
                <Button
                  variant={currentUserId === 7 ? "default" : "outline"}
                  size="sm"
                  onClick={() => setCurrentUserId(7)}
                >
                  ID: 7
                </Button>
                <Button
                  variant={currentUserId === 8 ? "default" : "outline"}
                  size="sm"
                  onClick={() => setCurrentUserId(8)}
                >
                  ID: 8
                </Button>
              </div>
            ...
            <p className="text-sm text-gray-600 mt-2">
              ...
              같은 ID로 설정하면 "자신과는 채팅할 수 없어요" 메시지가 나타납니다.
            </p>
          </CardContent>
        </Card>
