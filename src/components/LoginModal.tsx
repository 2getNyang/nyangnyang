            ...
            >
              <div className="flex items-center justify-center space-x-3">
                <svg className="w-6 h-6" viewBox="0 0 256 256" fill="none">
                  <path d="M128 0C57.308 0 0 40.297 0 90.909c0 32.621 21.097 61.286 53.412 77.097l-11.775 43.195c-1.8 6.6 6.65 11.756 11.745 7.143L93.67 183.11c11.47 1.8 23.392 2.752 35.641 2.752C198.692 185.862 256 145.565 256 90.909S198.692 0 128 0z" fill="currentColor"/>
                </svg>
                <span>카카오로 시작하기</span>
              </div>
            </Button>
